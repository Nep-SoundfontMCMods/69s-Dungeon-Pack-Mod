...
package soundfont.nep.dungeonsixnine.gui;
...
public class GuiWoodcrategui extends ElementsDungeon69Mod.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiWoodcrategui(ElementsDungeon69Mod instance) {
		super(instance, 9);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 27, 30) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 82, 30) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 137, 30) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				Dungeon69Mod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("dungeon69:textures/woodcrategui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Wooden Loot Crate", 46, 9, -1);
		}
		...
		protected void actionPerformed(GuiButton button) {
			Dungeon69Mod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
